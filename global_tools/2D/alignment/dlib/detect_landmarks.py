...
import numpy as np
import os
def detect_bbox_landmarks_single(img_dir, img_file):
...
def detect_bbox_landmarks(img_dir,txt_file):
    ...
    for i in range(len(all_lines)):
        print(i)
        try:
            bbox,landmarks=detect_bbox_landmarks_single(img_dir,all_lines[i])
...
if __name__=='__main__':
    img_dir=''
    txt_file='/home/scw4750/liangjie/testpicture/list.txt'
